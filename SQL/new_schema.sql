...
CREATE TABLE Fuel_History (
  ...
  Fuel_ID INT,
  Old_Fuel_Amount DECIMAL(10,2),
  New_Fuel_Amount DECIMAL(10,2),
  Change_Date DATETIME DEFAULT CURRENT_TIMESTAMP,
  FOREIGN KEY (Fuel_ID) REFERENCES FuelLog(Fuel_ID)
);
...
FOR EACH ROW
BEGIN
  INSERT INTO Inventory_History (Inventory_ID, Old_Quantity, New_Quantity)
  VALUES (OLD.Inventory_ID, OLD.Quantity, NEW.Quantity);
END//

CREATE TRIGGER after_fuel_update
AFTER UPDATE ON FuelLog
FOR EACH ROW
BEGIN
  INSERT INTO Fuel_History (Fuel_ID, Old_Fuel_Amount, New_Fuel_Amount)
  VALUES (OLD.Fuel_ID, OLD.Fuel_Amount, NEW.Fuel_Amount);
END//
